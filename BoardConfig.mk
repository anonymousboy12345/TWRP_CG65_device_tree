...
# Kernel offsets — verified from AIK unpack of boot_a.img
...
# Kernel - prebuilt (using kernel extracted from your boot_a.img)
...
# NOTE: Run "adb shell su -c blockdev --getsize64 /dev/block/by-name/boot_a"
# and replace 67108864 below with your actual value
...
BOARD_VORTEX_DYNAMIC_PARTITIONS_SIZE := 9122611200

# Metadata partition — named md_udc on this device
...
# Crypto — FBE v2 confirmed from fstab (aes-256-xts:aes-256-cts:v2)
